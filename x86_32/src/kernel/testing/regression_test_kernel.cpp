...
void test_kernel() {
    test_memory();
    Debug::fprintln("(PASSED) memory test module", Drivers::VGA::Color::LGREEN);

    test_string();
    Debug::fprintln("(PASSED) string test module", Drivers::VGA::Color::LGREEN);

    test_list();
    Debug::fprintln("(PASSED) list test module", Drivers::VGA::Color::LGREEN);

    test_array_utils();
    Debug::fprintln("(PASSED) arrayutils test module",
                    Drivers::VGA::Color::LGREEN);
}
